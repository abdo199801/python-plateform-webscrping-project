...
def serialize_business_with_lead(business: Business, record: Optional[LeadRecord]) -> dict:
    return {
        ...
        "extraction_sources": business.extraction_sources,
        "ai_place_summary": business.ai_place_summary,
        "ai_current_hours": business.ai_current_hours,
        "ai_popular_times": business.ai_popular_times,
        "ai_review_highlights": business.ai_review_highlights,
        "ai_grounding_sources": business.ai_grounding_sources,
        "ai_enrichment_status": business.ai_enrichment_status,
        "ai_enriched_at": business.ai_enriched_at,
        "dedupe_status": business.dedupe_status,
        "duplicate_of_business_id": business.duplicate_of_business_id,
        "dedupe_confidence": business.dedupe_confidence,
        "dedupe_notes": business.dedupe_notes,
